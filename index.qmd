...
* Rather than individual attribute classifications, we can evaluate across the population of respondents ([Sinharay & Johnson, 2019](https://doi.org/10.1007/978-3-030-05584-4_17))
...
* We can also evaluate the mastery probabilities across respondents
...
# Learn more:<br>[**r-dcm.org**](https://r-dcm.org) {.closing data-menu-title="Get in touch"}
